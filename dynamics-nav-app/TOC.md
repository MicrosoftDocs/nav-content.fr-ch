...
### [Inviter votre comptable externe dans votre Dynamics NAV](finance-invite-external-accountant.md)  
...
## [Gestion de vos relations client à l'aide de Dynamics 365 for Sales à partir de Dynamics NAV](marketing-integrate-dynamicscrm.md)
